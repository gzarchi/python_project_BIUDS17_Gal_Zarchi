...
# Define changed_default_temp to capture that unique pre-input state
changed_default_temp = selected_temp != temp_list[initial_temp_index]

# Define in which states buttons are displayed
...
if selected_not_default or (input_string and selection_settings):
...
if cond_s1 or cond_s2:
    ...
    if save_settings_button:
        f"save_settings({selection_settings[0]}, {selection_settings[1]}, {selected_temp})"
