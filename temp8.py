...
if changed_default_temp or found_typed_selection_settings:
    ...
    if save_settings_button or st.session_state['save_settings clicked'] == True:
        st.session_state['save_settings clicked'] = True
        st.write(f'save_settings({selection_settings[0]}, {selection_settings[1]}, {selected_temp})  -->  check if exists already and saves to favorites')
...
print(f'empty_typed_selection = {empty_typed_selection}')
print(f'found_typed_selection_settings = {found_typed_selection_settings}')
print(f'changed_default_temp = {changed_default_temp}')
print(f'selected_default = {selected_default}')
print('\n')